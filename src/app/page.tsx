              ...
              <dd>
                <ul>
                  ...
                  <li>
                    ...
                    <p className="intro">スマートデバイスに特化したインターネット事業。
                      プロダクト開発チーム所属時：CMS管理画面のUIUX、フロント開発業務。基本フロント1名、サーバーサイド1名、アプリエンジニア2名、PM1名、デザイナー1名、QA約2名のチーム編成で作業していました。
            ...
            <ul className="card_wrapper">
              <li className="card">
                ...
                <dl>
                  ...
                  <dt>GitHub</dt>
                  <dd><a href="" target="_blank">コード</a> : <a href="" target="_blank">ページ</a></dd>
